...
#### Team member A -- replace this with your name:
  ...
  **Do you think you worked consistently and put in enough work into the project (give a short answer). I want you to include the important links to your commits/test etc. 

  I want the link that I can click on to your commit or PullRequest with your work (not the branch you worked on). I also want a short description what this commit/PR is about (or test etc.)
  ...
  **Links to GitHub commits with main code contribution (up to 5 links) - important in each :
...
## 4: Checklist for you to see if you are done with the current Sprint
...
### For the next Sprint
  ...
  - [ ] You added new User Stories to your Product Backlog, they are correctly written (needed after Sprint 1, 2, 3)
